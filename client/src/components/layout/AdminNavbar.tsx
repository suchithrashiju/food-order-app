...
const links = [{ to: '/admin/orders', label: 'Orders' }]
      ...
      <div className="mx-auto flex h-16 w-full max-w-6xl items-center justify-between px-4 sm:px-6">
        ...
        <nav className="hidden items-center gap-1 md:flex" aria-label="Admin">
          ...
          <button
            ...
            className="cursor-pointer rounded-full px-4 py-2 text-sm font-medium text-slate-600 transition hover:bg-slate-100 dark:text-slate-300 dark:hover:bg-slate-800"
          >
            Logout
          </button>
        </nav>
